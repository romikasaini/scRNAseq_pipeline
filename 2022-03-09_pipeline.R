...
# This command takes path to sc-RNA data and produces result list containing:
# metrics (cell cycle percentage, ribosome share (range and percentage), mean mitochondrial percentage and erythrocyte percentage), 
# final seurat object, 
# mean and standard deviation values of CPM and raw counts per cluster of in CPM values and 
...
# N_dims:Number of dimesions to use for k-nearest neighbor graph
# UMAP_dims: Number of dimesions to use for UMAP
